//
//  CommonPlaceHolderTextView.swift
//  Chatbot
//
//  Created by Khusboo Singh on 07/08/23.
//
...
@IBDesignable
open class CommonPlaceHolderTextView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = CommonPlaceHolderTextView.Constants.defaultiOSPlaceholderColor {
        didSet {
